            ...
            <div id="respond">
                ...
                <?php else : ?>
                    ...
                    <form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform">
                        ...
                        <?php else : ?>
                            <label for="author">Nombre <small><?php if ($req) echo "(Requerido)"; ?></small></label>
                            <input type="text" name="author" id="author" value="<?php echo esc_attr($comment_author); ?>" size="22" tabindex="1" <?php if ($req) echo "aria-required='true'"; ?> />

                            <label for="email">E-mail <small><?php if ($req) echo "(Requerido)"; ?></small></label>
                        ...
                        <input class="transition" name="submit" type="submit" id="commentSubmit" tabindex="5" value="Enviar" />
