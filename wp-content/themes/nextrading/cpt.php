...
function portfolio_register() {
    ...
    $labels = array(
        ...
        'add_new' => _x('Add New', 'portafolio'),
        'add_new_item' => __('Add New Portafolio'),
        'edit_item' => __('Edit Portafolio'),
        'new_item' => __('New Portafolio'),
        'view_item' => __('View Portafolio'),
        'search_items' => __('Search Portafolio'),
